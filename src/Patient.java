...
public class Patient {
    ...
    public List<Patient> findHealthFriends(MyConnection conn) throws MyException {
        try {
            ...
            String query = "select DISTINCT p.pid, p.name from patient p, PatientClassRelationship pc where p.pid NOT IN (select h.fid from healthfriend h where h.pid = "+ this.pid+") and p.pid <> " + this.pid +
